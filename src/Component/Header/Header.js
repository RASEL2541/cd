    ...
    return (
        <div>
            <nav className="fixed-top d-flex bd-highlight navbar navbar-expand-lg navbar-light bg-primary">
                <a className="text-white font-weight-bold p-2 flex-grow-1 bd-highlight navbar-brand" href="#"><h4>Md.Rasel</h4></a>
                ...
                <div className="p-2 bd-highlight collapse navbar-collapse" id="navbarNav">
                    ...
                    <li className="nav-item active">
                        <a className="btn btn-primary font-weight-bold text-white nav-link" href="#">Home <span className="sr-only">(current)</span></a>
                    </li>
